          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center py-12 lg:py-20">
            <div className="space-y-6 animate-fade-in">
              <div className="inline-block space-y-2">
                ...
                <p className="font-display text-5xl font-bold px-[11px] py-0 text-center mx-[134px] my-[20px] lg:text-xl">Your One Stop Pet Paradise</p>
              </div>
              <h1 className="font-display text-5xl lg:text-6xl font-bold leading-tight mx-0 text-center my-0">
                Everything Your Pet{" "}
                <span className="bg-gradient-hero bg-clip-text text-transparent">
                  Needs & Loves
                </span>
              </h1>
              <p className="text-lg text-muted-foreground max-w-lg text-center px-0 mx-[63px]">
                Discover premium pet products, book grooming appointments, and get expert care - all in one place.
              </p>
              <div className="flex flex-wrap gap-4 mx-[44px]">
                <Button size="lg" className="bg-gradient-hero hover:opacity-90 shadow-md" asChild>
                  <Link to="/shop" className="mx-[57px]">
            ...
            <div className="relative animate-slide-up">
              ...
              loop: true
                ...
                <CarouselContent>
                  ...
                  <CarouselItem>
                    <video src={petVideo4} muted loop playsInline onMouseEnter={e => e.currentTarget.play()} onMouseLeave={e => e.currentTarget.pause()} className="rounded-3xl shadow-lg w-full object-cover aspect-video mx-0 px-0 py-0 my-[21px]" />
                  </CarouselItem>
                  <CarouselItem>
