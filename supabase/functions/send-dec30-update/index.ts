...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    console.log("Sending Dec 30 feature update email to:", requestData.to);

    const subject = "Purrkin Pets - December 30, 2025 Website Updates";
    ...
    console.log("Dec 30 feature update email sent successfully to:", requestData.to);
    ...
    console.error("Error in send-dec30-update function:", error);
    return new Response(
